<?php
$webroot ="http://localhost/Boutique/crud/";
...
?>
                    ...
                    <form method="post" action="update.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-2 row from-check ">
                            ...
                            ?>
                                <input type="checkbox" class="form-check-input" id="inputIsDeleted" name="is_deleted"
                                    value="1" checked>
                                <?php
                                    }else{
                                    ?>
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="inputProductType" name="product_type"
