...
$product1s = $_product->getActiveProduct();
?>
...
?>
                            <li class="mb-2"><a class="reset-anchor" href="category.php?cat=<?=$product['product_type'];?>"><?= $product['product_type']; ?></a></li>
                            <?php endforeach;?>
                        </ul>
            ...
            $_product = new Product();
            $products = $_product->Category($cat);
                                ...
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white bg-"></div><a class="d-block"
                                            href="detail.php?id=<?=$product['id'];?>"><img class="img-fluid w-100"
                                                src="<?= $webroot; ?>uploads/<?= $product['picture']; ?>" alt="..."></a>
