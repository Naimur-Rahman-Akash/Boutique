...
use Naimur\Pagination;
use Naimur\Product;
$page = isset($_GET['page']);
// $total_pages = ceil($total_results / $perPage);
$_product = new Product();
$_pago = new Pagination();
$total_pages = $_pago->page();            
$products= $_product->getActiveProductShop();
            $product1s = $_product->getActivecat();
            $pagis = $_pago->pagi($page);
            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        ...
                        <div class="py-2 px-4 bg-dark text-white mb-3"><strong
                                class="small text-uppercase fw-bold">Fashion &amp; Acc</strong></div>
                        ...
                        <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal mb-5">
                            <?php
                                ...
                                foreach ($product1s as $key=> $product) :
?>
                            <li class="mb-2"><a class="reset-anchor"
                                    href="category.php?cat=<?=$product['product_type'];?> ">
...
foreach ($pagis as $key=> $pagi) :
?>
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        <div class="badge text-white bg-"></div><a class="d-block"
                                            href="detail.php?id=<?=$pagi['id'];?>"><img class="img-fluid w-100"
                                                src="<?= $webroot; ?>uploads/<?= $pagi['picture']; ?>" alt="..."></a>
                                    ...
                                    <h6> <a class="reset-anchor"
                                            href="detail.php?id=<?=$pagi['id'];?>"><?= $pagi['title']; ?></a></h6>
                                    <p class="small text-muted">৳ <?= $pagi['price']; ?></p>
                                </div>
                                <?php
...
?>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center justify-content-lg-end">
                            ...
                            <li class="page-item ms-1"><a class="page-link" href="<?php echo "shop.php?page=$page"; ?>"
                                    aria-label="Next"><?php endfor;?>
